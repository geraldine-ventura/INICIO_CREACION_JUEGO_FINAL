...
class FormMenu(Form):
    def __init__(
        self, master_surface, x, y, w, h, color_background, color_border, active
    ):
        super().__init__(
            master_surface, x, y, w, h, color_background, color_border, active
        )
    ...
    def update(self, lista_eventos):
        for aux_widget in self.lista_widget:  # [self.boton1, self.boton2]

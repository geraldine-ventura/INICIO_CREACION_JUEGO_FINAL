...
class Player:
    def __init__(self, x, y, speed_walk, speed_run, gravity, jump) -> None:
        ...
        self.walk_l = Auxiliar.getSurfaceFromSpriteSheet(
            "CLASE_19_inicio_juego/images/caracters/stink/walk.png", 15, 1, True
        )[:12]
        ...
        self.jump_r = Auxiliar.getSurfaceFromSpriteSheet(
            "CLASE_19_inicio_juego/images/caracters/stink/jump.png", 33, 1, False, 2
        )
        self.jump_l = Auxiliar.getSurfaceFromSpriteSheet(
            "CLASE_19_inicio_juego/images/caracters/stink/jump.png", 33, 1, True, 2
        )
        self.frame = 0
        self.lives = 5
        self.score = 0

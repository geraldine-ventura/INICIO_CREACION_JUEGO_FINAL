...
class FormMenuB(Form):
    def __init__(
        ...
        self.txt1 = TextBox(
            ...
            color_border=None,
            image_background="CLASE_23_inicio_juego/images/gui/set_gui_01/Comic_Border/Buttons/Button_XL_08.png",
            text="Text",
            font="Verdana",
            font_size=30,
            font_color=C_BLACK,
    ...
    def on_click_boton2(self, parametro):
        ...
        with sqlite3.connect("CLASE_23_inicio_juego/db/db_score.db") as conexion:
            try:
                conexion.execute(
